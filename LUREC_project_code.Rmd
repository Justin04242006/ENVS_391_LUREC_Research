...
```
The 23rd observation is not statistically influential at alpha=0.01. Observations 10 and 24 are influential, and of these two data, observation 10 has the hgiher absolute residual value. Thus, I regenerate the model a sixth time, removing observation 10.
